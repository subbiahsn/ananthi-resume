export const resumeData = {
  ...
  experienceSummary:
    "A total of 9 years of experience with TCS (Tata Consultancy Services) and around 5 years of experience in various HR roles.",
  workExperience: [
    {
  ...
  awards: [
    "Awards for Excellence, tcsAI Spark (Aug 2025)",
    "Beyond Performance Awards, Xcelerate Warrior Certificate (Jun 2025)",
